#
#  Be sure to run `pod spec lint BundleImageCache.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/LoveLifeLoveSelf/BundleImageCache.git", :tag => s.version }
